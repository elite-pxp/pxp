document.addEventListener('DOMContentLoaded', () => {
  ...
  const apparelProductImages = [
    ...
    'https://assets.cdn.filesafe.space/CS4NGSgWYVqwkUR4I0Zh/media/6a8c54c9cdd4b797a32eb2ba.png',
  ...
  const closeShopModal = () => {
    ...
    15: { title: 'Unisex Restore by Jesus tee', desc: 'Purpose meets faith. The Driven T-Shirt declares that your steps are ordered by God and every move is fueled by faith, prayer, and divine purpose.', link: 'https://go.poweredxprayers.com/product-details/product/6a872e64d93e1268080acdbf' },
    16: { title: 'Unisex The Word is My Mirror tee', desc: 'Choose faith over fear every single day. This tee is a reminder that God has not given us a spirit of fear but of power, love, and a sound mind.', link: 'https://go.poweredxprayers.com/product-details/product/6a872e1633e47869c698814a' },
    17: { title: 'Unisex Restore by Jesus tee', desc: 'Your identity in Christ is priceless. This tee declares that you are chosen, redeemed, and valued beyond measure by the King of Kings.', link: 'https://go.poweredxprayers.com/product-details/product/6a872dc1d377ef4abb0c60cc' },
    18: { title: 'Unisex Prayer Room tee', desc: 'It is not by might nor by power, but by my Spirit, says the Lord. This tee is a declaration that everything you do flows from His strength.', link: 'https://go.poweredxprayers.com/product-details/product/6a872d75eba69a757e525654' },
    19: { title: 'Unisex Prayer Led tee', desc: 'Build your life on the solid rock. This tee is a call to kingdom builders who trust God\u2019s plan and build with faith, wisdom, and purpose.', link: 'https://go.poweredxprayers.com/product-details/product/6a872ccb58536b67d4ef61bc' },
    ...
    21: { title: 'Unisex Pray tee', desc: 'Stay grounded in faith. This tree-root design pairs \u2018ROOTED IN CHRIST\u2019 with the declaration that your identity begins with your Creator.', link: 'https://go.poweredxprayers.com/product-details/product/6a872b8f04c3021571006b94' },
    22: { title: 'Unisex Rooted tee', desc: 'Walk in spiritual authority every day. Featuring \u2018REIGN IN THE SPIRIT DAILY\u2019 with Romans 5:17, this tee declares that through Christ we reign in life.', link: 'https://go.poweredxprayers.com/product-details/product/6a872d3aef79b113e57c86e6' },
    23: { title: 'Unisex The Word is My Mirror tee', desc: 'See with the eyes of faith. What God has spoken over your life is greater than what your eyes can see. This tee is a declaration of supernatural vision.', link: 'https://go.poweredxprayers.com/product-details/product/6a872e1633e47869c698814a' },
