document.addEventListener('DOMContentLoaded', () => {
  ...
  const ebooksDetails = {
    0: { title: 'The Process' },
    1: { title: 'Stop Wishing, Start Building Wealth' },
    2: { title: 'Stop Wishing, Start Working (With Power!)' },
    3: { title: 'The Story of David' },
    4: { title: 'AI in Action' }
  };
  ...
  const apparelDetails = {
    ...
    5: { title: 'Driven Hoodie', desc: 'Purpose meets faith. The Driven Hoodie is a bold declaration that your steps are ordered by God and every move is fueled by faith, prayer, and divine purpose.' },
