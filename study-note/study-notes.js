(() => {
  ...
  const months = [
    ...
    ['September','Recognized',['vS9xvaB029s','ScQ8JHiAB-w','IXsXKhZGepE','ea95cJ3sMbw'],['September 1|Recognize the Battle: What Is Really Operating?','September 8|What you keep reacting to may only be the fruit. God wants to show you the root.','September 15|RECOGNIZE Week 3: Renounce & Resist | Break the Agreement, Take Your Stand','September 22|RECOGNIZED Week 4']],['October','Coming Soon',[],[]],['November','Coming Soon',[],[]],['December','Coming Soon',[],[]]
  ];
